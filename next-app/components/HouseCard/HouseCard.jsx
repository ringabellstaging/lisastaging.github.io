...
export default function CardDemo({post}) {
  return (
    <div className="max-w-xs w-full h-full group/card p-1">
      <Link href={`/${post.id}`} className="block">
        <div
          className="cursor-pointer overflow-hidden relative card h-96 rounded-md shadow-sm max-w-sm mx-auto backgroundImage flex flex-col justify-between p-4 bg-cover"
        ...
        >
          ...
          <div className="text content">
            ...
            <p className="font-normal text-sm text-gray-50 relative z-10 my-4 whitespace-pre-line">
              {post?.text}
            </p>
          </div>
        </div>
